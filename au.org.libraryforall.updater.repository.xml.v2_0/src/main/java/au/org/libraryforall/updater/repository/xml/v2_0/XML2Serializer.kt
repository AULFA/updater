...
class XML2Serializer(private val outputStream: OutputStream) : SPIFormatXMLSerializerType {
  ...
  private fun ofRepository(document: Document, repository: Repository): Element {
    val root =
      document.createElementNS(RepositoryXML2Format.NAMESPACE.toString(), "r:Repository");
  ...
  private fun ofAndroidPackage(
    ...
    val root =
      document.createElementNS(RepositoryXML2Format.NAMESPACE.toString(), "r:AndroidPackage");
  ...
  private fun ofOPDSPackage(
    ...
    val root =
      document.createElementNS(RepositoryXML2Format.NAMESPACE.toString(), "r:OPDSPackage");

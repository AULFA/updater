...
class XML3RepositoryHandler(locator2: Locator2)
  ...
  override fun onWantHandlerName(): String =
    XML3RepositoryHandler::class.java.simpleName

  override fun onWantChildHandlers(): Map<String, () -> SPIFormatXMLContentHandlerType<RepositoryItem>> =
    mapOf(
      Pair("AndroidPackage", {
        XML3RepositoryAndroidPackageHandler(super.locator(), this.self)
      }),
      Pair("OPDSPackage", {
        XML3RepositoryOPDSPackageHandler(super.locator(), this.self)
      })
    )

...
abstract class RepositoryXMLv1ParserContract {
  ...
  private fun stream(name: String): InputStream {
    return RepositoryXMLv1ParserContract::class.java.getResourceAsStream(
      "/au/org/libraryforall/updater/tests/v1/${name}")!!
  }

...
abstract class RepositoryXMLv3ParserContract {
  ...
  fun testSimple() {
    ...
    Assert.assertEquals(4, repository.items.size)
    ...
    Assert.assertEquals(null, p0.installPasswordSha256)
    ...
    Assert.assertEquals(Hash("1e142e6277b12b7e1110478a24caee8f006a9349e86970c890203d6266209463"), p1.installPasswordSha256)
    ...
    Assert.assertEquals(null, p2.installPasswordSha256)

    val p3 = repository.items[3]
    Assert.assertEquals("c11fb660-8fdd-4c95-99fb-f754653cea83", p3.id)
    Assert.assertEquals(1, p3.versionCode)
    Assert.assertEquals("0001-01-01T00:00:00.000Z", p3.versionName)
    Assert.assertEquals("1e142e6277b12b7e1110478a24caee8f006a9349e86970c890203d6266209463", p3.sha256.text)
    Assert.assertEquals("http://www.example.com/4", p3.source.toASCIIString())
    Assert.assertEquals(Hash("d0addeb753c36c0c4b0f180ca9361eb7cb18107b3ddda6aea12c0756f8f08d82"), p3.installPasswordSha256)
  }
  ...
  private fun stream(name: String): InputStream {
    return RepositoryXMLv3ParserContract::class.java.getResourceAsStream(
      "/au/org/libraryforall/updater/tests/v3/${name}")!!
  }

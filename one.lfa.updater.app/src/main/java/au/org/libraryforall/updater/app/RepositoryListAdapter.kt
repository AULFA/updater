...
class RepositoryListAdapter(
  ...
  : ListAdapter<InventoryRepositoryType, RepositoryListAdapter.ViewHolder>(au.org.libraryforall.updater.app.RepositoryListAdapter.Companion.diffUtilCallback) {

...
import one.lfa.updater.inventory.api.InventoryHashIndexedDirectoryType.KeyReservationType
import one.lfa.updater.inventory.api.InventoryHashIndexedDirectoryType.ReservationUnavailableException
import one.lfa.updater.inventory.api.InventoryHashIndexedDirectoryType.VerificationResult
import one.lfa.updater.inventory.api.InventoryHashIndexedDirectoryType.VerificationResult.VerificationCancelled
import one.lfa.updater.inventory.api.InventoryHashIndexedDirectoryType.VerificationResult.VerificationFailure
import one.lfa.updater.inventory.api.InventoryHashIndexedDirectoryType.VerificationResult.VerificationSuccess

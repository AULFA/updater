...
class XML2RepositoryHandler(locator2: Locator2)
  ...
  override fun onWantHandlerName(): String =
    XML2RepositoryHandler::class.java.simpleName

  override fun onWantChildHandlers(): Map<String, () -> SPIFormatXMLContentHandlerType<RepositoryItem>> =
    mapOf(
      Pair("AndroidPackage", {
        XML2RepositoryAndroidPackageHandler(super.locator(), this.self)
      }),
      Pair("OPDSPackage", {
        XML2RepositoryOPDSPackageHandler(super.locator(), this.self)
      })
    )

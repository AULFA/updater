...
class RepositoryXML2Format : SPIFormatVersionedHandlerProviderType<Repository> {
  ...
  companion object {
    val NAMESPACE = URI.create("urn:one.lfa.updater.repository.xml:2.0")
  }
  ...
  override val schemaDefinition: SPISchemaDefinition =
    SPISchemaDefinition(
      ...
      location = RepositoryXML2Format::class.java.getResource("/one/lfa/updater/repository/xml/v2_0/schema-2.0.xsd"))
}
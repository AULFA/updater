...
class OPDSManifestXML10Format : SPIFormatVersionedHandlerProviderType<OPDSManifest> {
  ...
  override val schemaDefinition: SPISchemaDefinition =
    SPISchemaDefinition(
      ...
      location = OPDSManifestXML10Format::class.java.getResource("/one/lfa/updater/opds/xml/v1_0/schema-1.0.xsd"))
}